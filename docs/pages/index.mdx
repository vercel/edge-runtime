...
The Edge Runtime is a subset of standard Web APIs, giving you compatability and interoperability with the highest number of environments. This project is developed as part of [WinterCG](https://wintercg.org) – a community group between Vercel, Cloudflare, Deno, Shopify, and more.
